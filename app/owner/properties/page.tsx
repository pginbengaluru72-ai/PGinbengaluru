    ...
    <div className="space-y-6 pb-12">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Manage your PG properties and track live Super Admin verification status.</p>
        </div>
        <Link href="/owner/properties/new" className="inline-flex items-center justify-center rounded-xl text-sm font-bold bg-indigo-600 text-white hover:bg-indigo-700 h-10 px-5 shadow-md transition-all">
          ...
          <Card key={property.id} className="overflow-hidden border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl">
            ...
            <CardContent className="pt-2 space-y-3">
              ...
              <div className="flex items-center justify-between text-xs font-semibold pt-1">
                ...
                <span className="capitalize px-2.5 py-0.5 bg-slate-100 dark:bg-slate-800 rounded-md text-slate-700 dark:text-slate-300">{property.type} PG</span>
              </div>
            ...
            <div className="p-5 space-y-5">
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200/60 dark:border-slate-800">
                  ...
                  <span className="font-bold text-indigo-600 dark:text-indigo-400">{selectedProperty.whatsappNumber}</span>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200/60 dark:border-slate-800">
                ...
                <div className="p-3 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200/60 dark:border-slate-800">
                  ...
                  <span className="font-bold text-emerald-600 dark:text-emerald-400">{selectedProperty.availableBeds} Beds</span>
                </div>
              </div>
