                  ...
                  <div className="flex items-start gap-4 w-full sm:w-auto flex-1">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-1 text-sm text-slate-500 dark:text-slate-400">
                        <span className="flex items-center gap-1 font-medium"><MapPin className="h-3.5 w-3.5 text-indigo-500" /> {v.locality}, {v.city} {v.pincode ? `- ${v.pincode}` : ''}</span>
                        <span className="font-bold text-slate-700 dark:text-slate-300">Starts at ₹{v.startingPrice || 0}/mo</span>
